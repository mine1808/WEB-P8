...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="oceanone.css">
   ...
   <body data-bs-spy="scroll" data-bs-target=".navbar">
      ...
      <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white">
         <div class="container">
            <a class="navbar-brand logo-text" href="#"><img src="waste.png" class="logo-img"><span style="color: rgb(83, 94, 178);">OCEAN</span>ONE</a>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                  <div class="col-lg-6">
                     <img class="img-fluid" src="ilustrasi-sampah-plastik.jpg">
                  </div>
                  <div class="col-lg-6">
               ...
               <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                  ...
                  <div class="col-lg-6">
                     <img class="img-fluid" src="antarafoto-paving-block-sampah-plastik-151020-aaa-5.jpg">
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                  <div class="col-lg-6">
                     <img class="img-fluid" src="jaring.jpg">
                  </div>
                  <div class="col-lg-6">
                     <div class="text-center h-100 project">
                        <div class="d-flex h-100">
               ...
               <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                  ...
                  <div class="col-lg-6">
                     <img class="img-fluid" src="ikan.jpg">
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="row justify-content-between gy-3">
            <div class="col-md-6">
               <a class="navbar-brand logo-text" href="#">
                  <img src="waste.png" class="logo-img">
